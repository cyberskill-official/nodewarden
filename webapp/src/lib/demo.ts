...
export const DEMO_CIPHERS: Cipher[] = [
  ...
  },
  {
    ...
    card: {
      cardholderName: 'CyberWarden Demo',
      number: '4111 1111 1111 1111',
      brand: 'Visa',
      expMonth: '12',
      expYear: '2030',
      code: '123',
      decCardholderName: 'CyberWarden Demo',
...
export const DEMO_SENDS: Send[] = [
  {
    ...
    text: { text: 'Welcome to CyberWarden demo mode.', hidden: false },
    decText: 'Welcome to CyberWarden demo mode.',
    accessCount: 3,
    maxAccessCount: 10,
    disabled: false,
...
export function getDemoPublicSend(accessId: string): {
  ...
  if (normalized === 'demo-note') {
    return {
      ...
      type: 0,
      decName: 'Onboarding note',
      decText: 'Welcome to CyberWarden demo mode. This public Send page is served entirely from demo data.',
