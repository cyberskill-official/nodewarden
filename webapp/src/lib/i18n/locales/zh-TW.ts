...
const zhTW: Record<string, string> = {
  ...
  "txt_yubikey_config_required_help": "請先輸入一次 YubiKey OTP。CyberWarden 會自動取得並保存實例級 Client ID 和 Secret key，成功後再進入 YubiKey 設定表單。",
  ...
  "txt_loading": "加載中...",
  "txt_loading_nodewarden": "正在加載 CyberWarden...",
  ...
  "txt_online": "在線",
  "txt_offline": "離線",
  "txt_offline_vault_readonly": "目前為離線模式，只能查看密碼庫。連線到 CyberWarden 後才能修改。",
