...
const zhCN: Record<string, string> = {
  ...
  "txt_yubikey_config_required_help": "请先输入一次 YubiKey OTP。CyberWarden 会自动获取并保存实例级 Client ID 和 Secret key，成功后再进入 YubiKey 设置表单。",
  ...
  "txt_loading": "加载中...",
  "txt_loading_nodewarden": "正在加载 CyberWarden...",
  ...
  "txt_online": "在线",
  "txt_offline": "离线",
  "txt_offline_vault_readonly": "当前为离线模式，只能查看密码库。连接到 CyberWarden 后才能修改。",
