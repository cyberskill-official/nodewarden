...
const es: Record<string, string> = {
  ...
  "txt_yubikey_config_required_help": "Introduce primero un OTP de YubiKey. CyberWarden solicitará y guardará automáticamente el Client ID y la Secret key de la instancia, y luego abrirá el formulario de YubiKey.",
  ...
  "txt_loading_nodewarden": "Cargando CyberWarden...",
  ...
  "txt_nodewarden_send": "Envío CyberWarden",
  ...
  "txt_offline_vault_readonly": "El modo sin conexión es de solo lectura. Conecta con CyberWarden antes de cambiar la bóveda.",
