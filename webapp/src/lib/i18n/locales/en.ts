...
const en: Record<string, string> = {
  ...
  "txt_yubikey_config_required_help": "Enter one YubiKey OTP first. CyberWarden will automatically request and save the instance Client ID and Secret key, then open the YubiKey setup form.",
  ...
  "txt_loading": "Loading...",
  "txt_loading_nodewarden": "Loading CyberWarden...",
  ...
  "txt_nodewarden_send": "CyberWarden Send",
  ...
  "txt_online": "Online",
  "txt_offline": "Offline",
  "txt_offline_vault_readonly": "Offline mode is read-only. Connect to CyberWarden before changing your vault.",
