...
const ru: Record<string, string> = {
  ...
  "txt_yubikey_config_required_help": "Сначала введите один OTP с YubiKey. CyberWarden автоматически запросит и сохранит Client ID и Secret key экземпляра, затем откроет форму настройки YubiKey.",
  ...
  "txt_loading_nodewarden": "Загрузка CyberWarden...",
  ...
  "txt_nodewarden_send": "CyberWarden Отправить",
  ...
  "txt_online": "Онлайн",
  "txt_offline": "Офлайн",
  "txt_offline_vault_readonly": "Автономный режим доступен только для чтения. Подключитесь к CyberWarden, чтобы изменить хранилище.",
